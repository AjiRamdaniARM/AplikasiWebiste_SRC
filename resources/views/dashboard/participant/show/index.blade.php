                            ...
                            <div class="relative overflow-hidden bg-white dark:bg-gray-800 mb-12 hover-grayscale-0 wow fadeInUp rounded-2xl p-5"
                                ...
                                <div class="pt-6 text-center">
                                    ...
                                    <button data-modal-target="authentication-modal{{ $data->id }}"
                                        ...
                                        class="relative bg-blue-500 text-white mt-2 px-2 rounded-md hover:scale-105 hover:bg-blue-300">Edit
                                        Data</button>
                                    @if ($data->race && $data->race->category && $data->race->category->name == 'online')
                                        @if ($data->projectonlines && $data->projectonlines && $data->projectonlines->status == 'sudah upload')
                                            <button type="button"
                                                ...
                                                onclick="alert('Mohon Menunggu Tahap Selanjunya')">Sudah Upload</button>
                                        @else
                                            <button type="button"
                                            ...
                                            <div class="relative  rounded-lg shadow bg-gray-900">
                                                ...
                                                <div class="p-4 md:p-5">
                                                    <form class="space-y-4"
                                                        action="{{ url('particpants/' . $data->id) }}" method="POST">
                                                        @csrf
                                                        <div>
                                                            <label for="email"
